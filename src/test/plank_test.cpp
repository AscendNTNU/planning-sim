...
TEST (PlankTest, UpdatePlankTest) {
	...
	float Config::ROBOT_TURN_TIME = 2.5;

	//5.94 meters is approximately how far a ground robot drives in 18 seconds
	Plank plank = Plank(point, angle, time_after_turn_start, Config::ROBOT_TURN_TIME);
	...
	plank.updatePlank(point, angle, time_after_turn_start, Config::ROBOT_TURN_TIME);
